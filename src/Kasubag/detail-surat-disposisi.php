...
<head>
  ...
  <title>Detail-Surat-Disposisi-Kasubag</title>
    ...
    <div class="main flex-column">
      ...
      <div class="content-status-surat" style="padding: 20px; margin: 0 20px 0 20px;">
        ...
        <table class="table " style="text-align: center;  border-radius: 5px;"" >
          ...
          <tbody>
            <td>
              <textarea style="width: 800px;" name="laporan" id="" cols="30" rows="10"></textarea>
            </td>
          </tbody>
      ...
      <div class="d-flex">
        <button class="add-surat">Submit</button> 
        <button class="add-surat" onclick="window.location.href = 'surat-tugas.php';">Kembali</button> 
      </div>
