      ...
      <div class="row card-section-surat-masuk">
        <table class="table table-fluid" id="example">
          ...
          <tbody>
            <tr>
              <th scope="row">001</th>
              <td>B/2190/UNI42.8/PT.01.04/2023</td>
              <td>Biasa</td>
              <td>1</td>
              <td>Kerja Praktik</td>
              <td>20/01/2023</td>
            ...
            <tr>
              <th scope="row">003</th>
              <td>A/98/DISPAR/2021</td>
              <td>Biasa</td>
              <td>1</td>
              <td>Kunjungan Pariwisata</td>
              <td>19/03/2021</td>
            ...
            <tr>
              <th scope="row">003</th>
              <td>090/B/1021/BRGLGR</td>
              <td>Biasa</td>
              <td>1</td>
              <td>Kerja Bakti</td>
              <td>16/03/2023</td>
              <td>Banjar Gelogor</td>
              <td>
                <div class="action-button">
                  <button class="delete-button" >Delete</button>
                  <button class="edit-button" >Edit</button>
            ...
            <tr>
              <th scope="row">003</th>
              <td>G1/120/2A/BUPATI</td>
              <td>Penting</td>
              <td>1</td>
              <td>Rapat</td>
              <td>20/05/2023</td>
              <td>Kantor Bupati Badung</td>
              <td>
                <div class="action-button">
                  <button class="delete-button" >Delete</button>
                  <button class="edit-button" >Edit</button>
